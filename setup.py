...
from src.CSparse3.__version__ import CSparse3Version
...
base_path = os.path.join('src', 'CSparse3')
...
setup(
    ...
    version=CSparse3Version,  # Required
    ...
    url='https://github.com/SanPen/CSparse3',  # Optional
